...
TEST(SortedSetMembersTest, ZcardReturnsSortedSetCardinality) {
  ...
  ASSERT_TRUE((std::holds_alternative<RespInteger>(*result))) << "ZCARD should return a RESP integer";
  ASSERT_TRUE((std::get<RespInteger>(*result).value == 4)) << "ZCARD should return the number of members in the sorted set";
  ...
  ASSERT_TRUE((std::holds_alternative<RespInteger>(*result))) << "updating an existing member should return a RESP integer";
  ASSERT_TRUE((std::get<RespInteger>(*result).value == 0)) << "updating an existing member should not change cardinality";

  result = executor.Execute({"ZCARD", "zset_key"});
  ASSERT_TRUE((result.has_value())) << "ZCARD after update should succeed";
  ASSERT_TRUE((std::holds_alternative<RespInteger>(*result))) << "ZCARD after update should return a RESP integer";
  ASSERT_TRUE((std::get<RespInteger>(*result).value == 4)) << "ZCARD should remain unchanged after updating an existing member";

  result = executor.Execute({"ZCARD", "missing_key"});
  ASSERT_TRUE((result.has_value())) << "ZCARD missing key should succeed";
  ASSERT_TRUE((std::holds_alternative<RespInteger>(*result))) << "ZCARD missing key should return a RESP integer";
  ASSERT_TRUE((std::get<RespInteger>(*result).value == 0)) << "ZCARD missing key should return zero";
}
...
TEST(SortedSetMembersTest, ZscoreReturnsSortedSetMemberScore) {
  ...
  ASSERT_TRUE((std::holds_alternative<redis::RespBulkString>(*result))) << "ZSCORE should return a RESP bulk string";
  ASSERT_TRUE((std::get<redis::RespBulkString>(*result).value == "30.1")) << "ZSCORE should return the member score";
  ...
  ASSERT_TRUE((std::holds_alternative<RespInteger>(*result))) << "updating a sorted-set member should return a RESP integer";
  ASSERT_TRUE((std::get<RespInteger>(*result).value == 0)) << "updating a sorted-set member should not add a new entry";

  result = executor.Execute({"ZSCORE", "zset_key", "zset_member2"});
  ASSERT_TRUE((result.has_value())) << "ZSCORE after update should succeed";
  ASSERT_TRUE((std::holds_alternative<redis::RespBulkString>(*result))) << "ZSCORE after update should return a RESP bulk string";
  ASSERT_TRUE((std::get<redis::RespBulkString>(*result).value == "100.99")) << "ZSCORE should return the updated score";

  result = executor.Execute({"ZSCORE", "zset_key", "zset_member100"});
  ASSERT_TRUE((result.has_value())) << "ZSCORE missing member should succeed";
  ASSERT_TRUE((std::holds_alternative<redis::RespNullBulk>(*result))) << "ZSCORE missing member should return a null bulk string";
  ...
  ASSERT_TRUE((std::holds_alternative<redis::RespNullBulk>(*result))) << "ZSCORE missing key should return a null bulk string";
}
...
TEST(SortedSetMembersTest, ZremRemovesSortedSetMember) {
  ...
  ASSERT_TRUE((std::holds_alternative<RespInteger>(*result))) << "ZREM should return a RESP integer";
  ASSERT_TRUE((std::get<RespInteger>(*result).value == 1)) << "ZREM should report one removed member";
  ...
  ASSERT_TRUE((std::holds_alternative<redis::RespArray>(*result))) << "ZRANGE after ZREM should return a RESP array";
  ASSERT_TRUE((std::get<redis::RespArray>(*result).values ==
  ...
  ASSERT_TRUE((std::holds_alternative<RespInteger>(*result))) << "ZREM missing member should return a RESP integer";
  ASSERT_TRUE((std::get<RespInteger>(*result).value == 0)) << "ZREM missing member should report zero removals";
}
