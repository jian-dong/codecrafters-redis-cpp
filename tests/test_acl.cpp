...
TEST(AclTest, WhoamiReturnsDefaultUser) {
  ...
  ASSERT_TRUE(((*result).Is<redis::RespBulkString>())) << "ACL WHOAMI should return a RESP bulk string";
  ASSERT_TRUE(((*result).Get<redis::RespBulkString>().value == "default")) << "ACL WHOAMI should return the default user";
...
TEST(AclTest, GetuserReturnsFlagsAndPasswordsForDefaultUser) {
  ...
  ASSERT_TRUE(((*result).Is<redis::RespArray>())) << "ACL GETUSER default should return a structured RESP array";
...
TEST(AclTest, SetuserStoresHashedPasswordAndClearsNopass) {
  ...
  ASSERT_TRUE(((*result).Is<RespSimpleString>())) << "ACL SETUSER should return a RESP simple string";
  ASSERT_TRUE(((*result).Get<RespSimpleString>().value == "OK")) << "ACL SETUSER should return OK";
  ...
  ASSERT_TRUE(((*result).Is<redis::RespArray>())) << "ACL GETUSER default should return a structured RESP array after setting a password";
  ASSERT_TRUE((RespWriter::Write(*result) ==
